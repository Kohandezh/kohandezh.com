...
(function () {
  ...
  var T = {
    ...
    ru: {
      nav1: "Документы сертификатов", nav2: "Благодарности и награды",
      nav3: "Назначения в комиссии и комитеты", nav4: "Записи, указанные в LinkedIn",
      nav5: "Как читать этот архив",
      s1k: "Документированные материалы", s1t: "Записи, подтверждённые сертификатами",
      s1d: "Сорок три уникальных изображения сертификатов, сверенных с архивом, приведённых к единому размеру полотна и упорядоченных от новых к старым по дате получения или выдачи. Выберите любое изображение, чтобы рассмотреть запись в полном размере.",
      s2k: "Профессиональное признание", s2t: "Благодарственные письма и награды",
      s2d: "Шестнадцать уникальных благодарственных писем, отзывов об оказанных услугах и наград, упорядоченных от новых к старым. В одном отзыве использована дата оказания услуги, указанная в его тексте. Все страницы PDF сохранены как изображения одинакового размера.",
      s3k: "Управление и отраслевые роли", s3t: "Приказы о назначении в комиссии и комитеты",
      s3d: "Четыре официальных письма о назначении Мохаммада Али Кохандежа в профильные отраслевые комиссии и на руководящие позиции в комитетах, упорядоченные от новых к старым.",
      s4k: "Запись в LinkedIn", s4t: "Сопоставленные публичные записи",
      s4d: "Десять записей, в настоящее время видимых в публичном профиле LinkedIn, сверенных с локальным архивом сертификатов и упорядоченных по дате получения.",
      nk: "Как читать этот архив", nt: "Прозрачный указатель портфолио",
      np1: "Эта страница — кураторская профессиональная запись, а не портал проверки, управляемый выдающей организацией. <em>Документ сертификата</em> означает, что полное изображение хранится локально; <em>сопоставлено с LinkedIn и документом</em> означает, что название и выдавшая организация также присутствуют в текущей публичной записи LinkedIn.",
      np2: "Несколько файлов PDF или JPG, относящихся к одной и той же организации, названию и достижению, представлены одной карточкой. Точные дни берутся из документа сертификата; благодарности без видимой в документе даты помечаются, а не угадываются.",
      noteFacts: "Единственное расхождение по месяцу в MCPS показано явно, а документ MCTS 2011 года остаётся отдельным от записи MCTS за сентябрь 2014 года.",
      st1: "Документы сертификатов", st2: "Благодарности и награды", st3: "Назначения в комиссии", st4: "Запись в LinkedIn", st5: "Порядок в архиве", dRec: "документированных записей", dMatch: "сопоставленных записей", dOrder: "Сначала новые по дате получения", note: "Источник важнее сокращения — названия организаций, наименования и даты следуют документу сертификата или записи LinkedIn. Кураторская запись портфолио, а не служба проверки в реальном времени.",
      footPortfolio: "Портфолио"
    }
  };
