...
"ar": dict(
 ...
 v_edu="دكتوراه في إدارة تقنية المعلومات؛ ماجستير في إدارة تقنية المعلومات / الأعمال الإلكترونية، جامعة طهران",
...
"de": dict(
 ...
 v_edu="Promotion, IT-Management; M.Sc., IT-Management / E-Business, Universität Teheran",
...
"es": dict(
 ...
 v_edu="Doctorado en Gestión de TI; Máster en Gestión de TI / negocio electrónico, Universidad de Teherán",
...
"fr": dict(
 ...
 v_edu="Doctorat en gestion des TI ; Master en gestion des TI / commerce électronique, Université de Téhéran",
...
"tr": dict(
 ...
 v_edu="BT Yönetimi doktorası; BT Yönetimi / e-İş yüksek lisansı, Tahran Üniversitesi",
...
"zh": dict(
 ...
 v_edu="信息技术管理博士；德黑兰大学信息技术管理／电子商务硕士",
...
"ja": dict(
 ...
 v_edu="IT マネジメント博士／テヘラン大学 IT マネジメント・e ビジネス修士",
