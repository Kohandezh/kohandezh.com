                                ...
                                <div class="infiniteSlide-brand eco-marquee">
                                    ...
                                    <a href="https://blogyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">WordPress için yapay zekâ editör ekibi</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://abryar.com" target="_blank" rel="noopener" class="eco-card eco-card--soon">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">Çok yakında</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                ...
                                <ul class="award-list">
                                    <li class="award-item hover-cursor-img">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-1-w320.webp 320w" sizes="158px" alt="VMware VCP-DCV 2021 sertifikası">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-2-w320.webp 320w" sizes="158px" alt="CEH sertifikası">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-3-w320.webp 320w" sizes="158px" alt="CHFI sertifikası">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-4-w320.webp 320w" sizes="158px" alt="SEC504 sertifikası">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-6-w320.webp 320w" sizes="158px" alt="SEC542 sertifikası">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-5-w320.webp 320w" sizes="158px" alt="HPE ATP Server Solutions sertifikası">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
<!-- CV:BEGIN generated from assets/data/cv.json by _tooling/cv/build.py -- do not edit by hand -->
                                    ...
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="ksf-ceo" data-cv-type="work">
                                        <p class="timeline-date text-black-56">Aralık 2013 - Günümüz</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                    ...
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="modaberan" data-cv-type="work">
                                        <p class="timeline-date text-black-56">Temmuz 2018 - Şubat 2024</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                            ...
                            <div id="tech" class="section-tech-stack flat-spacing">
                                ...
                                <ul class="tech-list">
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image">
                                                <img loading="lazy" width="29" height="28" src="<?php echo KDCV; ?>/assets/images/section/tech-4.svg?v=2026091701" alt="Kuantum hazırlık danışmanlığı simgesi">
                                            </div>
                                            <div class="tech_info">
                                                <p class="info__name fw-medium text-black-72">Kuantum hazırlık danışmanlığı</p>
                                                <p class="info__duty text-black-56 text-body-3">Kriptografik envanter ve NIST kuantum sonrası standartlarına geçiş
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech" data-tech-brand="arctera">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark"><img loading="lazy" width="160" height="43" src="<?php echo KDCV; ?>/assets/images/section/tech-arctera.svg?v=2026091701" alt="Arctera logosu"></div>
                                            <div class="tech_info">
                                    ...
                                    <li class="wg-tech" data-tech-brand="veritas">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark"><img loading="lazy" width="24" height="24" src="<?php echo KDCV; ?>/assets/images/section/tech-veritas.svg?v=2026091701" alt="Veritas logosu"></div>
                                            <div class="tech_info">
