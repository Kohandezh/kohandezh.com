(function () {
  ...
  var localeLabels = {
    ...
    es: { theme: "Apariencia", language: "Idioma", smaller: "Reducir el avatar", larger: "Ampliar el avatar", switch: "Cambiar estilo del avatar", size: "Tamaño del avatar", hide: "Ocultar avatar", show: "Mostrar avatar" },
    ru: { theme: "Оформление", language: "Язык", smaller: "Уменьшить аватар", larger: "Увеличить аватар", switch: "Изменить стиль аватара", size: "Размер аватара", hide: "Скрыть аватар", show: "Показать аватар" },
