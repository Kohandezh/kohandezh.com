...
<head>
    ...
    <meta name="description"
        content="محمدعلی کهن‌دژ — دکتری مدیریت فناوری اطلاعات و مدیرعامل شرکت کهن سیستم فردا (KSF)؛ فعال حرفه‌ای از سال ۲۰۰۷ در هوش مصنوعی، زیرساخت فناوری اطلاعات و امنیت سایبری.">
...
<link rel="stylesheet" href="<?php echo KDCV; ?>/assets/fonts/iransansx/iransansx.css">
  ...
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    ...
    <!-- SEO: canonical -->
    <link rel="canonical" href="<?php echo esc_url( home_url('/fa/') ); ?>">
    ...
    <link rel="alternate" type="text/plain" title="llms.txt" href="https://kohandezh.com/fa-llms.txt">
  <link rel="alternate" type="application/rss+xml" title="Mohammad Ali Kohandezh — نوشته‌های منتخب" href="/feed.xml">
    ...
    <meta property="og:description" content="محمدعلی کهن‌دژ — دکتری مدیریت فناوری اطلاعات و مدیرعامل شرکت کهن سیستم فردا (KSF)؛ فعال حرفه‌ای از سال ۲۰۰۷ در هوش مصنوعی، زیرساخت فناوری اطلاعات و امنیت سایبری.">
    ...
    <meta name="twitter:description" content="محمدعلی کهن‌دژ — دکتری مدیریت فناوری اطلاعات و مدیرعامل شرکت کهن سیستم فردا (KSF)؛ فعال حرفه‌ای از سال ۲۰۰۷ در هوش مصنوعی، زیرساخت فناوری اطلاعات و امنیت سایبری.">
                        ...
                        <div class="wrap-container">
                            ...
                            <div id="about" class="section-about flat-spacing">
                                ...
                                <p class="s-desc text-black-56 scrolling-effect effectTop">
                                    ...
                                    <br>
                                    مدیرعامل شرکت کهن سیستم فردا (KSF)، دارای دکتری مدیریت فناوری اطلاعات،
                                    با نگاهی توأمان به دقت مهندسی و بینش کسب‌وکار.
                                ...
                                <ul class="award-list">
                                    <li class="award-item hover-cursor-img">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-1-w320.webp 320w" sizes="158px" alt="گواهی‌نامهٔ VMware VCP-DCV 2021">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-2-w320.webp 320w" sizes="158px" alt="گواهی‌نامهٔ CEH">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-3-w320.webp 320w" sizes="158px" alt="گواهی‌نامهٔ CHFI">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-4-w320.webp 320w" sizes="158px" alt="گواهی‌نامهٔ SEC504">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-6-w320.webp 320w" sizes="158px" alt="گواهی‌نامهٔ SEC542">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-5-w320.webp 320w" sizes="158px" alt="گواهی‌نامهٔ HPE ATP Server Solutions">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
<!-- CV:BEGIN generated from assets/data/cv.json by _tooling/cv/build.py -- do not edit by hand -->
                                    ...
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="ksf-ceo" data-cv-type="work">
                                        <p class="timeline-date text-black-56">دسامبر ۲۰۱۳ - اکنون</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                    ...
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="modaberan" data-cv-type="work">
                                        <p class="timeline-date text-black-56">ژوئیهٔ ۲۰۱۸ - فوریهٔ ۲۰۲۴</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                            ...
                            <div id="tech" class="section-tech-stack flat-spacing">
                                ...
                                <ul class="tech-list">
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image">
                                                <img loading="lazy" width="29" height="28" src="<?php echo KDCV; ?>/assets/images/section/tech-4.svg?v=2026091701" alt="آیکن مشاوره آمادگی کوانتومی">
                                            </div>
                                            <div class="tech_info">
                                    ...
                                    <li class="wg-tech" data-tech-brand="arctera">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark">
                                                <img loading="lazy" width="160" height="43" src="<?php echo KDCV; ?>/assets/images/section/tech-arctera.svg?v=2026091701" alt="لوگوی Arctera">
                                            </div>
                                            <div class="tech_info">
                                    ...
                                    <li class="wg-tech" data-tech-brand="veritas">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark">
                                                <img loading="lazy" width="24" height="24" src="<?php echo KDCV; ?>/assets/images/section/tech-veritas.svg?v=2026091701" alt="لوگوی Veritas">
                                            </div>
                                            <div class="tech_info">
              ...
              <a href="<?php echo esc_url( home_url('/terms/') ); ?>">شرایط استفاده</a>
                                ...
                                <div class="foot-bottom">
                                    <p class="text-nocopy text-black-56 effectFade fadeUp no-div">
                                        ...
                                        © ۱۴۰۵ محمدعلی کهن‌دژ
                                        <a class="fontiran-license" target="_blank" rel="noopener" aria-label="پروانهٔ کاربرد فونت ایران — FontIran" href="https://fontiran.com/license/VC3960YS">
