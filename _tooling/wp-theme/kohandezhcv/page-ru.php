<?php /* KohandezhCV — CV page, auto-applied to page slug 'ru' (generated by sync-from-static.py, do not hand-edit) */ ?>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru" dir="ltr" data-kdcv-router-mode="wordpress" data-kdcv-site-base="<?php echo esc_url(home_url('/')); ?>">
...
<head>
  ...
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
    ...
    <link rel="stylesheet" href="<?php echo KDCV; ?>/assets/css/glowing-effect.min.css?v=2026091101" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="<?php echo KDCV; ?>/assets/css/glowing-effect.min.css?v=2026091101"></noscript>
    ...
    <style>
        ...
        /* Russian typography: Inter ships only `latin` and `latin-ext`
           subsets, so its unicode-range never covers U+0400-04FF. Cyrillic was
           falling through to the browser's generic sans-serif while Latin runs
           on the same line ("Kohan System Farda", "VMware") rendered in Inter
           -- one page set in two unrelated typefaces.

           Follows the zh/ja precedent: a system stack rather than a new
           webfont. Every target platform ships a good Cyrillic face already,
           and adding a multi-hundred-KB download to fix a fallback would cost
        ...
        html[lang="ru"] li, html[lang="ru"] div, html[lang="ru"] blockquote,
        html[lang="ru"] button, html[lang="ru"] input,
        html[lang="ru"] select, html[lang="ru"] textarea {
            font-family: "Inter", "PT Sans", "Segoe UI", "Helvetica Neue", Roboto, "Noto Sans", Arial, sans-serif;
        }
        .demo-mode-toggle {
            display: flex;
            flex-wrap: wrap;
  ...
  <link rel="alternate" type="application/rss+xml" title="Mohammad Ali Kohandezh — избранные статьи" href="/feed.xml">
    ...
    <meta name="twitter:title" content="Mohammad Ali Kohandezh — специалист по ИИ, кибербезопасности и ИТ-инфраструктуре">
    <meta name="twitter:description" content="Mohammad Ali Kohandezh — PhD в области управления информационными технологиями, генеральный директор Kohan System Farda (KSF). Профессиональный опыт с 2007 года в областях ИИ, корпоративной ИТ-инфраструктуры, виртуализации, резервного копирования и восстановления, а также кибербезопасности.">
    ...
    <script type="application/ld+json">
{
        ...
        "mainEntity": [
            ...
            },
            {
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Kohan System Farda (KSF) is an enterprise IT and AI company founded and led by Mohammad Ali Kohandezh, based at ТехнологииElite, the Nokhbegan Технологииnology Growth Center (Masir 21), Pardis Technology Park, Tehran, Iran. KSF's website is https://ksf.ir."
                }
            },
            {
                "@type": "Question",
    ...
    <script type="application/ld+json">
    {
      ...
      "name": "Mohammad Ali Kohandezh — IT Infrastructure, Cybersecurity & AI-консалтинг",
    ...
    <script type="application/ld+json">
    {
      ...
      "url": "https://kohandezh.com/",
      "name": "Mohammad Ali Kohandezh — Personal Professional Портфолио",
  ...
  <script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ProfilePage",
  "@id": "https://kohandezh.com/#profilepage",
  "url": "https://kohandezh.com/",
  "inLanguage": "ru",
...
<script>/* Theme boot — runs before paint so a page never flashes the wrong theme on navigation. Mirrors main.js: stored choice wins, then data-default-mode, then light. `light` is the class portfolio.js uses. */(function(){try{var s=localStorage.getItem("darkMode"),d;if(s!==null){d=s==="enabled";}else{d=document.body.getAttribute("data-default-mode")==="dark";}document.body.classList.toggle("dark-mode",d);document.body.classList.toggle("light",!d);document.documentElement.setAttribute("data-kdcv-theme",d?"dark":"light");}catch(e){}})();</script>
  <a class="kd-skip-link" href="#wrapper">Перейти к содержимому</a>
    ...
    <div class="tf-left-bar">
        <a class="btn-setting-color tf-btn-icon style-2" data-bs-toggle="offcanvas" href="#languageMenu" aria-label="Выберите язык"><span class="language-button-label" aria-hidden="true">EN</span></a>
    </div>
    <!-- /Btn Open Language -->
    <!-- Language Menu -->
    <div class="offcanvas offcanvas-end offcanvas-color" id="languageMenu">
        <div class="offcanvas-content">
            <div class="canvas-header">
                <h5 class="letter-space--2">Язык</h5>
                <span class="icon-close-popup" data-bs-dismiss="offcanvas">
                    <i class="icon-close"></i>
                </span>
            </div>
            <div class="canvas-body">
                <h6 class="title">Выберите язык</h6>
                <div class="settings-color list-choose lang-list">
                    ...
                    <button type="button" class="btn-color choose-item lang-item is-active" data-lang="ru" data-dir="ltr">
                        <span class="text">🇷🇺 RU — Русский</span>
                    </button>
                </div>
                <p class="text-body-3 text-black-56" style="margin-top:16px;">
                    Выберите язык, чтобы просмотреть профиль, резюме и контактные данные на предпочитаемом вами языке.
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Menu Mobile -->
    <div class="action-open-mobile d-lg-none" role="button" tabindex="0" aria-label="Открыть меню навигации" aria-expanded="false">
            ...
            <ul class="nav-mobile-item">
                <li class="nav-item">
                    <a href="#home" class="item-link scroll-link">
                        ...
                        <p class="tool-tip text-caption">Главная</p>
                    </a>
                </li>
                <li class="br-line"></li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#contact" class="item-link scroll-link">
                        <i class="icon icon-send"></i>
                        <p class="tool-tip text-caption">Контакты</p>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="sidebar-tools pst-v1">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="#education" class="item-link scroll-link">
                    <i class="icon icon-edu"></i>
                    <p class="tool-tip text-caption">Образование</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="#work" class="item-link scroll-link">
                    <i class="icon icon-high-light"></i>
                    <p class="tool-tip text-caption">Работа</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="#service" class="item-link scroll-link">
                ...
                <div class="user-info">
                    <h5 class="greeting letter-space--2 text-white animationtext clip">
                        ...
                        <span class="cd-words-wrapper">
                            ...
                            <span class="item-text is-hidden">ИТ-стратег</span>
                            <span class="item-text is-hidden">Генеральный директор KSF</span>
                        </span>
                    </h5>
                    <p class="introduce text-white-56 letter-space--05 text-body-3">
                        Я помогаю предприятиям выстраивать безопасную и
                        отказоустойчивую ИТ-инфраструктуру. Базируюсь в Тегеране (Иран) и работаю из
                        TechElite, Nokhbegan Technology Growth Center
                        (Masir 21), Pardis Technology Park.
                    </p>
                    ...
                    <div class="action-group">
                        ...
                        <a href="<?php echo KDCV; ?>/assets/contact/Mohammad-Kohandezh-CV-ATS-EN.pdf" download class="action-down" aria-label="Скачать резюме">
                        ...
                        <div class="wrap-container">
                            ...
                            <div id="home" class="section-intro flat-spacing">
                                <div class="intro-author effectFade fadeUp no-div">
                                    ...
                                    <div class="author-info letter-space--05">
                                        ...
                                        <p class="info_duty text-black-50 text-body-3">Специалист по ИИ, кибербезопасности и ИТ-инфраструктуре
                                        </p>
                                    </div>
                                </div>
                                ...
                                <p class="intro-client letter-space--05 text-body-3">
                                    ...
                                    Нам доверяют банки и крупные компании
                                </p>
                                    ...
                                    <div class="brand-track">
                                        ...
                                        <div class="image-brand">
                                            <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/brand/brand-1_dark.svg" width="132" height="24"
                                                src="<?php echo KDCV; ?>/assets/images/brand/brand-1.svg" alt="Банк Parsian" loading="lazy" decoding="async">
                                        </div>
                                        <div class="image-brand">
                                            <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/brand/brand-2_dark.svg" width="122" height="24"
                                                src="<?php echo KDCV; ?>/assets/images/brand/brand-2.svg" alt="Банк Sarmayeh" loading="lazy" decoding="async">
                                        </div>
                                        <div class="image-brand">
                                            <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/brand/brand-3_dark.svg" width="125" height="24"
                                                src="<?php echo KDCV; ?>/assets/images/brand/brand-3.svg" alt="Банк Mehr Eghtesad" loading="lazy" decoding="async">
                                        </div>
                                        <div class="image-brand">
                                            <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/brand/brand-4_dark.svg" width="112" height="24"
                                                src="<?php echo KDCV; ?>/assets/images/brand/brand-4.svg" alt="Тегеранская торговая палата" loading="lazy" decoding="async">
                                        </div>
                                        <div class="image-brand">
                                            <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/brand/brand-5_dark.svg" width="112" height="24"
                                                src="<?php echo KDCV; ?>/assets/images/brand/brand-5.svg" alt="Больница Noor" loading="lazy" decoding="async">
                                        </div>
                                        <!-- Set 2 -->
                                        <div class="image-brand">
                                            <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/brand/brand-1_dark.svg" width="132" height="24"
                                ...
                                <div class="infiniteSlide-brand eco-marquee">
                                    ...
                                    <a href="https://padyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">Платформа ИИ-ассистента</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    ...
                                    <span class="eco-tag">Продукт для ИИ-процессов и ИИ-ассистентов</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://netyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">Ещё один ИИ-продукт из экосистемы KSF</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://kohansystemfarda.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">Официальный сайт компании</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    ...
                                    <a href="https://padyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            <span class="eco-name">Padyar.com</span>
                                            <span class="eco-tag">Платформа ИИ-ассистентов</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://homayar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            <span class="eco-name">Homayar.com</span>
                                    <span class="eco-tag">Продукт для автоматизации рабочих процессов и ИИ-ассистентов</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://netyar.com" target="_blank" rel="noopener" class="eco-card">
                            ...
                            <div id="about" class="section-about flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                    Создание ИИ-продуктов и <br class="d-none d-lg-block">
                                    защищённую инфраструктуру с <br class="d-none d-lg-block">
                                    профессиональная практика с 2007 года
                                </h2>
                                ...
                                <div class="professional-roles">
                                    <h3 id="professional-roles-title" class="h5 professional-roles__heading letter-space--2 text-black-72">
                                        Профессиональные и общественные роли
                                    </h3>
                                    <ul class="professional-roles__list">
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">Председатель комитета по кибербезопасности</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">НКО в области Интернета вещей и науки о данных</p>
                                            </div>
                                            <span class="professional-role__badge">Руководство</span>
                                        </li>
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">Координатор волонтёрской группы Nehzate Noor va Danesh</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">Nehzate Noor va Danesh</p>
                                            </div>
                                            <span class="professional-role__badge">Общественная деятельность</span>
                                        </li>
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">Член комиссий по ИИ и науке о данных, по сетям и IoT</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">Иранская гильдия ИКТ (IranNSR)</p>
                                            </div>
                                            <span class="professional-role__badge">Членство в профессиональных сообществах</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="certificates" class="section-about flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                    Сертификаты, подтверждающие описанный выше опыт
                                </h2>
                                <ul class="award-list">
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">VCP-DCV 2021 — виртуализация центров обработки данных</h3>
                                    ...
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">CEH — Сертифицированный этичный хакер</h3>
                                    ...
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">CHFI — Специалист по расследованию компьютерных преступлений
                                            </h3>
                                            <p class="award_desc text-black-56">SABA Safe Village</p>
                                        </div>
                                        <h4 class="h6 award_year text-black-72">
                                    ...
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">SEC504 — курс по техникам хакерских атак</h3>
                                            <p class="award_desc text-black-56">SABA Safe Village</p>
                                        </div>
                                        <h4 class="h6 award_year text-black-72">
                                            Пентестинг
                                    ...
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">SEC542 — обучение тестированию на проникновение веб-приложений</h3>
                                            <p class="award_desc text-black-56">SABA Safe Village</p>
                                        </div>
                                        <h4 class="h6 award_year text-black-72">
...
<!-- CV:BEGIN generated from assets/data/cv.json by _tooling/cv/build.py -- do not edit by hand -->
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="national-ai-platform" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Участник разработки национальной платформы ИИ с открытым исходным кодом в Иране.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="ksf-ceo" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Руковожу продуктами в сфере искусственного интеллекта, услугами кибербезопасности и корпоративной инфраструктурой, включая Padyar, HomaYar, MeetYar и BlogYar.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="phd-it-management" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">Доктор философии (PhD) — менеджмент информационных технологий, интеллектуальный бизнес</p>
                                                <p class="timeline-desc text-black-56">Исламский университет Азад, Центральный Тегеранский филиал · средний балл 17,70/20.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="modaberan" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Корпоративные сети, продукты в области кибербезопасности, инфраструктура резервного копирования, VMware, решения для хранения данных и техническая поддержка.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="saba-safe-village" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Проводил обучение по Backup Exec, кибербезопасности и инфраструктуре.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="haft-tappeh" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Управлял ИТ-инфраструктурой, виртуализацией, корпоративными сетями, мониторингом безопасности и автоматизацией.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="msc-it-management" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">Магистр (MSc) — менеджмент информационных технологий, электронный бизнес</p>
                                                <p class="timeline-desc text-black-56">Тегеранский университет · средний балл 15,97/20.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="golzar-ettesal" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Оказывал услуги по корпоративным сетям, инфраструктуре и технической поддержке.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="azad-university" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Администрировал сетевые и Интернет-услуги в Центральном Тегеранском филиале.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="power-control" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Проектировал, обслуживал и поддерживал компьютерные сети и системы.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="mca-computer-software" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">MCA — технологии компьютерного программного обеспечения</p>
                                                <p class="timeline-desc text-black-56">Мешхедский университет им. Фирдоуси · средний балл 16,72/20.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="negareh" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Обеспечивал хранение данных, резервное копирование, мониторинг сетей и поддержку систем для корпоративных заказчиков.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="best-design" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Обеспечивал поддержку сетей и ИТ для рабочих станций отдела дизайна интерьеров и офисных систем.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="novin-gostar-aysa" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Выполнял установку, настройку и обслуживание сетевых и компьютерных систем.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="culham" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Обеспечивал поддержку офисных операций, компьютерных сетей и систем.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="associate-computer-software" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">Степень ассоциата — разработка компьютерного программного обеспечения</p>
                                                <p class="timeline-desc text-black-56">Исламский университет Азад, Фирузкухский филиал · завершено в июле 2009 года.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="amen-behin" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Оказывал поддержку компьютерного оборудования, сетей и систем.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- CV:END -->
                            ...
                            <div id="work" class="section-work flat-spacing">
                                ...
                                <div class="work-list element-sticky">
                                    <div class="sticky-item">
                                        <div class="wg-work">
                                            <div class="work-image">
                                                <img loading="lazy" width="1600" height="900" src="<?php echo KDCV; ?>/assets/images/section/work-ksf-localized.webp" alt="Скриншот KSF.ir">
                                            </div>
                                            <div class="wrap">
                                                <div class="work-content">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-top">
                                                            ...
                                                            <p class="w-tagline text-white-72 text-body-2 fw-medium" style="letter-spacing:.04em">
                                                                «Мы проектируем вашу цифровую жизнь»
                                                            </p>
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                Моя холдинговая компания — ИТ-инфраструктура,
                                                                ИИ-продукты
                                                                и консалтинг в области
                                                                кибербезопасности
                                                            </p>
                                    ...
                                    <div class="sticky-item">
                                        <div class="wg-work">
                                            <div class="work-image">
                                                <img loading="lazy" width="1600" height="900" src="<?php echo KDCV; ?>/assets/images/section/work-padyar-localized.webp" alt="Скриншот Padyar.com">
                                            </div>
                                            <div class="wrap">
                                                <div class="work-content">
                                                    <div class="w-image">
                                                        <img loading="lazy" width="468" height="856" src="<?php echo KDCV; ?>/assets/images/section/work-padyar-localized.webp"
                                                            alt="Скриншот Padyar.com">
                                                    </div>
                                                    <div class="content">
                                                        <div class="content-top">
                                                            <div class="w-logo">
                                                            ...
                                                            <h3 class="w-title letter-space--2 text-white-72">
                                                                Padyar — платформа ИИ-аватаров
                                                            </h3>
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                Платформа ИИ-аватаров — придайте ИИ вашей организации
                                                                человеческий облик
                                                                с естественным синтезом речи
                                                            </p>
                                                            <div class="w-highlight">
                                                                <div class="box-high">
                                                                    <p class="text-body-3 text-white-56">
                                    ...
                                    <div class="sticky-item">
                                        <div class="wg-work">
                                            <div class="work-image">
                                                <img loading="lazy" width="1600" height="900" src="<?php echo KDCV; ?>/assets/images/section/work-homayar-localized.webp" alt="Превью продукта Homayar.com">
                                            </div>
                                            <div class="wrap">
                                                <div class="work-content">
                                                    <div class="w-image">
                                                        <img loading="lazy" width="468" height="856" src="<?php echo KDCV; ?>/assets/images/section/work-homayar-localized.webp"
                                                            alt="Предварительный просмотр продукта Homayar.com">
                                                    </div>
                                                    <div class="content">
                                                        <div class="content-top">
                                                            <div class="w-logo">
                                                            ...
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                Продукт для автоматизации рабочих процессов на базе ИИ и интеллектуальный ассистент
                                                                из технологической экосистемы Kohan System Farda
                                                            </p>
                                                            <div class="w-highlight">
                                                                <div class="box-high">
                                                                    <p class="text-body-3 text-white-56">
                                ...
                                <div class="work-cta effectFade fadeUp no-div">
                                    <div>
                                        <h3 class="h5 letter-space--2 text-black-72">Планируете проект?</h3>
                                        <p class="text-body-3 text-black-56">Расскажите о своих задачах в области инфраструктуры, безопасности или ИИ — я лично отвечу в течение одного рабочего дня.</p>
                                    </div>
                                    <a href="#contact" class="tf-btn-action">
                                        <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                        <span class="text text-body-3 letter-space--05 fw-medium">Предложить сотрудничество</span>
                                        <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                    </a>
                                </div>
                            <!-- /Работа Highlight -->
                                ...
                                <div class="" id="accordion-service">
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-ai" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">Искусственный интеллект и умная автоматизация</h3>
                                            <div class="ic-wrap">
                                        ...
                                        <div id="service-ai" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                <div class="tf-grid-layout sm-col-2 lg-col-3">
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-padyar-localized.webp" alt="Корпоративная платформа ИИ-аватаров Padyar">
                                                        </div>
                                                    </div>
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-homayar-localized.webp" alt="Платформа ИИ-аналитики звонков Homayar">
                                                        </div>
                                                    </div>
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-ksf-localized.webp" alt="Корпоративные ИИ-решения KSF">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="service-tag">
                                                    <a href="#service" class="tag-item text-body-3 fw-medium text-black-72 link">
                                                        Корпоративный ИИ-аватар (Padyar)
                                                    </a>
                                                    <a href="#service" class="tag-item text-body-3 fw-medium text-black-72 link">
                                                        ИИ-аналитика звонков (Homayar)
                                                    </a>
                                                    <a href="#service" class="tag-item text-body-3 fw-medium text-black-72 link">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    Проектирование и внедрение корпоративного ИИ — от говорящих аватаров и цифровых двойников
                                                    до аналитики качества звонков и автоматизации процессов с помощью ИИ-агентов — локально или в облаке.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-1" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">Инфраструктура и виртуализация</h3>
                                            <div class="ic-wrap">
                                                <span class="ic-accordion-custom"></span>
                                            </div>
                                        </div>
                                        <div id="service-1" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    Я проектирую и эксплуатирую корпоративные центры обработки данных — виртуализация,
                                                    серверы и системы хранения — созданные
                                                    для производительности, доступности и роста.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-2" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">Резервное копирование и аварийное восстановление</h3>
                                            <div class="ic-wrap">
                                                <span class="ic-accordion-custom"></span>
                                            </div>
                                        </div>
                                        <div id="service-2" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    Корпоративные решения резервного копирования и аварийного восстановления на базе Arctera Backup Exec,
                                                    Veeam и Veritas NetBackup — защита критически важных
                                                    данных по проверенным планам восстановления и репликации.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-3" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">Кибербезопасность и криминалистика</h3>
                                            <div class="ic-wrap">
                                                <span class="ic-accordion-custom"></span>
                                            </div>
                                        </div>
                                        <div id="service-3" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    Оценка уровня безопасности, усиление защиты и реагирование на инциденты
                                                    с опорой на сертификаты CEH, CHFI и опыт обучения по безопасности —
                                                    мы сохраним вашу организацию защищённой и готовой к аудиту.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="tech" class="section-tech-stack flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                    Узнайте, как мой опыт работы с этими <br class="d-none d-sm-block">
                                    платформ даёт лучшие результаты
                                </h2>
                                <ul class="tech-list">
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">Корпоративная виртуализация</p>
                                            </div>
                                        </div>
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">Защита и восстановление данных
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">Обучение по программам HPE ATP, CEH и в области кибербезопасности
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech" data-tech-brand="arctera">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">Резервное копирование, восстановление данных и аварийное восстановление</p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech" data-tech-brand="veritas">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">Корпоративное резервное копирование и восстановление в масштабе предприятия</p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                            <div class="progress-line" data-progress="85">
                            ...
                            <div id="blog" class="section-blog flat-spacing">
                                ...
                                <div class="blog-local-list" data-kdcv-blog-feed data-loaded="<?php echo esc_attr( min( 6, (int) wp_count_posts( 'post' )->publish ) ); ?>" data-read-label="Читать оригинал">
                                    <?php echo kdcv_render_home_blog_feed( 'Читать оригинал', 6 ); ?>
                                </div>
                                <a href="<?php echo esc_url( home_url('/blog/') ); ?>" class="tf-btn-action" style="margin-top:24px;">
                                    <span class="text text-body-3 letter-space--05 fw-medium">Открыть полный архив блога</span>
                                    <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                </a>
                            </div>
                            <!-- /Blog -->
                            ...
                            <div id="testimonial" class="section-testimonial flat-spacing">
                                ...
                                <div class="heading overflow-hidden">
                                    <div class="head-left">
                                        <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                            Вот что <br class="d-none d-lg-block">
                                            говорят люди
                                        </h2>
                                        <div class="box-counter effectFade fadeUp no-div">
                                            <div class="wg-counter">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-v01">
                                                    ...
                                                    <div class="tes-author">
                                                        ...
                                                        <p class="text-body-3 text-black-56">Финансовые услуги
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div id="demo" class="section-demo flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 split-text effect-blur-fade">
                                    Поговорите с доктором Kohandezh напрямую или <br class="d-none d-lg-block">
                                    к его ИИ-аватару и цифровому двойнику
                                </h2>
                                <div class="demo-mode-toggle" role="tablist" aria-label="Тип демо">
                                    <button type="button" class="demo-mode-btn is-active" data-mode="human" role="tab" aria-selected="true">
                                        ...
                                        <span>Поговорить с доктором Kohandezh</span>
                                    </button>
                                    <button type="button" class="demo-mode-btn" data-mode="avatar" role="tab" aria-selected="false">
                                        ...
                                        <span>Поговорите с ИИ-аватаром</span>
                                    </button>
                                </div>
                                <p class="demo-mode-note" data-mode-note="human">Живое общение с Mohammad Ali Kohandezh — для обсуждения стратегических, управленческих и технических вопросов.</p>
                                <p class="demo-mode-note" data-mode-note="avatar" hidden>Структурированная беседа с ИИ-аватаром и цифровым двойником доктора Kohandezh, обученными на его профессиональных знаниях и доступными в любое время. Оставьте свои контактные данные, и мы вышлем вам ссылку на сессию.</p>
                                <form class="form-contact form-demo" id="demoform" action="https://api.web3forms.com/submit" method="POST">
                                    ...
                                    <input type="hidden" name="contact_mode" id="demo-mode-field" value="Поговорить с доктором Kohandezh">
                                    ...
                                    <div class="form-content effectFade fadeUp no-div">
                                        ...
                                        <fieldset class="field-ip">
                                            <select name="field_of_interest" id="demo-field" required>
                                                ...
                                                <option value="ИТ-инфраструктура">ИТ-инфраструктура</option>
                                                <option value="Кибербезопасность">Кибербезопасность</option>
                                                <option value="Резервное копирование и аварийное восстановление">Резервное копирование и аварийное восстановление</option>
                                    ...
                                    <div class="form-action effectFade fadeUp no-div">
                                        <div class="send-wrap">
                                            <button type="submit" class="tf-btn animate-btn animate-dark">
                                                <span class="text-body-3" data-mode-cta="human">Заказать звонок</span>
                                                <span class="text-body-3" data-mode-cta="avatar" hidden>Поговорить с ИИ-аватаром</span>
                                            </button>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div id="contact" class="section-contact flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 split-text effect-blur-fade">
                                    Если у вас есть общий или проектный запрос <br class="d-none d-lg-block">
                                    вопрос, пожалуйста, напишите мне на электронную почту <br class="d-none d-lg-block">
                                    или заполните форму — доступно уже сейчас
                                </h2>
                                ...
                                <div class="contact-schedule">
                                    ...
                                    <div class="schedule-embed" data-booking-url="">
                                        ...
                                        <div class="schedule-fallback">
                                            <p>Идёт настройка системы онлайн-записи. Пока что напишите мне напрямую на электронную почту — в ответ вы получите ссылку на Google Meet.</p>
                                            <a href="mailto:Kohandezh@hotmail.com" class="tf-btn-action"><span class="text text-body-3 fw-medium">Записаться по email</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <footer id="footer" class="tf-footer flat-spacing">
                                <div class="block-quote effectFade fadeUp no-div">
                                    <p class="h5 quote-text font-3 fw-normal text-black-72">
                                        ...
                                        Дизайн — это не просто то, как вещь выглядит и воспринимается. Дизайн — это то, как она работает.
                                        <span class="text-black-56">”</span>
                                    </p>
    ...
    <noscript>
        ...
        <section class="linkedin-noscript" aria-labelledby="linkedin-noscript-title">
            <h2 id="linkedin-noscript-title">Рекомендации и активность в LinkedIn</h2>
            <p>Оригиналы рекомендаций и ссылки на активность из общедоступного профиля Mohammad Ali Kohandezh на LinkedIn.</p>
            <ul>
                <li><a href="https://www.linkedin.com/in/nextnoble/" target="_blank" rel="noopener noreferrer">Mohammad Abdellahi</a> · <time datetime="2023-11-25">25 ноября 2023 г.</time></li>
                <li><a href="https://www.linkedin.com/in/shahram-dehghani/" target="_blank" rel="noopener noreferrer">Shahram Dehghani</a> · <time datetime="2023-04-05">5 апреля 2023 г.</time></li>
                <li><a href="https://www.linkedin.com/in/ihadijafari/" target="_blank" rel="noopener noreferrer">Hadi Jafari</a> · <time datetime="2023-01-17">17 января 2023 г.</time></li>
                <li><a href="https://www.linkedin.com/in/shahramgolzar/" target="_blank" rel="noopener noreferrer">Shahram Golzar</a> · <time datetime="2023-01-16">16 января 2023 г.</time></li>
            </ul>
            <h3>Недавняя активность в LinkedIn</h3>
            <ul>
                <li><a href="https://www.linkedin.com/feed/update/urn:li:activity:7388299488152424448/" target="_blank" rel="noopener noreferrer">GITEX 2025 — аналитический взгляд на мировые технологические инновации</a> · <time datetime="2025-10-26">26 октября 2025 г.</time></li>
                <li><a href="https://www.linkedin.com/feed/update/urn:li:activity:7382455627651919872/" target="_blank" rel="noopener noreferrer">Expand North Star — крупнейшее в мире мероприятие для стартапов</a> · <time datetime="2025-10-10">10 октября 2025 г.</time></li>
            </ul>
        </section>
    </noscript>
