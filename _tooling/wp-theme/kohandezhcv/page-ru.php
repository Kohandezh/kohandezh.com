...
<head>
  ...
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
    ...
    <link rel="stylesheet" href="<?php echo KDCV; ?>/assets/css/glowing-effect.min.css?v=106" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="<?php echo KDCV; ?>/assets/css/glowing-effect.min.css?v=106"></noscript>
                            ...
                            <div id="education" class="section-education-experience flat-spacing">
                                ...
                                <div class="timeline scroll-down">
                                    ...
                                    <div class="timeline-item effectFade fadeUp no-div">
                                        <p class="timeline-date text-black-56">Сейчас</p>
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <p class="timeline-role fw-medium text-black-72">Соискатель степени PhD</p>
                                            <p class="timeline-desc text-body-3 text-black-56">
                                                В настоящее время получаю вторую докторскую степень, одновременно возглавляя KSF.
                                            </p>
                                        </div>
                                    </div>
                                                                        <div class="timeline-item effectFade fadeUp no-div">
                                        <p class="timeline-date text-black-56">2026 — настоящее время</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img loading="lazy" width="32" height="32" src="<?php echo KDCV; ?>/assets/images/item/sako.webp" alt="Национальная платформа ИИ с открытым исходным кодом">
                                            </div>
                                            <p class="timeline-role fw-medium text-black-72">Разработчик — национальная платформа ИИ с открытым исходным кодом</p>
                                            <p class="timeline-desc text-body-3 text-black-56">Участник разработки национальной платформы ИИ с открытым исходным кодом в Иране.</p>
                                            <figure class="sako-project-visual">
                                                <img src="<?php echo KDCV; ?>/assets/images/portfolio/sako-platform-concept.webp" width="1536" height="1024" loading="lazy" decoding="async" alt="Концептуальная редакционная визуализация открытой модульной инфраструктуры национальной ИИ-платформы">
                                            </figure>
                                        </div>
                                    </div>
                                    <!-- Item 2 -->
                                    <div class="timeline-item effectFade fadeUp no-div">
                                        <p class="timeline-date text-black-56">2024 — настоящее время</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                            ...
                                            <p class="timeline-role fw-medium text-black-72">Генеральный директор — Kohan System Farda
                                                (KSF)</p>
                                            <p class="timeline-desc text-body-3 text-black-56">
                                                Руковожу работами в области ИИ, кибербезопасности и ИТ-инфраструктуры — включая
                                                платформу ИИ-ассистента Padyar, платформу ИИ-агентов, а также продукты HomaYar,
                                                MeetYar, БлогYar, NetYar и ГлавнаяYar.
                                            </p>
                                        </div>
                                    </div>
                                    <!-- Item 3 -->
                                    <div class="timeline-item effectFade fadeUp no-div">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <p class="timeline-role fw-medium text-black-72">PhD — менеджмент ИТ,
                                                умный бизнес</p>
                                            <p class="timeline-desc text-body-3 text-black-56">
                                                Исламский университет Азад, Центральный тегеранский филиал. Завершено параллельно
                                                с полноценной работой над инфраструктурой.
                                            </p>
                                        </div>
                                    </div>
                                    <!-- Item 4 -->
                                    <div class="timeline-item effectFade fadeUp no-div">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <p class="timeline-role fw-medium text-black-72">Старший специалист технической поддержки
                                                — Modaberan Fanavari Pasargad</p>
                                            <p class="timeline-desc text-body-3 text-black-56">
                                                Виртуализация, инфраструктура резервного копирования, решения VMware
                                                и корпоративные системы хранения данных.
                                            </p>
                                        </div>
                                    </div>
                                    <!-- Item 5 -->
                                    <div class="timeline-item effectFade fadeUp no-div">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <p class="timeline-role fw-medium text-black-72">MSc — менеджмент ИТ,
                                                электронный бизнес</p>
                                            <p class="timeline-desc text-body-3 text-black-56">
