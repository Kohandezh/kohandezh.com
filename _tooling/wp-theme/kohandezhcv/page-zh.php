...
<head>
  ...
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    ...
    <!-- SEO: canonical -->
    <link rel="canonical" href="<?php echo esc_url( home_url('/zh/') ); ?>">
    ...
    <link rel="alternate" type="text/plain" title="llms.txt" href="https://kohandezh.com/zh-llms.txt">
  <link rel="alternate" type="application/rss+xml" title="Mohammad Ali Kohandezh — 精选文章" href="/feed.xml">
                        ...
                        <div class="wrap-container">
                                ...
                                <div class="infiniteSlide-brand eco-marquee">
                                    ...
                                    <a href="https://blogyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">面向 WordPress 的 AI 编辑团队</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                            ...
                            <div id="about" class="section-about flat-spacing">
                                ...
                                <p class="s-desc text-black-56 scrolling-effect effectTop">
                                    ...
                                    <br>
                                    作为科汉系统未来（KSF）首席执行官和IT管理博士， <br class="d-none d-lg-block">
                                    我以严谨的工程精神和
                                    商业洞察力对待每一个项目。我也为企业提供量子就绪咨询——密码资产盘点、
                                    数据保存期限分析，以及向 NIST 后量子标准的迁移路线。
                                </p>
                                ...
                                <ul class="award-list">
                                    <li class="award-item hover-cursor-img">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-1-w320.webp 320w" sizes="158px" alt="VMware VCP-DCV 2021 证书">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-2-w320.webp 320w" sizes="158px" alt="CEH 证书">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-3-w320.webp 320w" sizes="158px" alt="CHFI 证书">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-4-w320.webp 320w" sizes="158px" alt="SEC504 证书">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-6-w320.webp 320w" sizes="158px" alt="SEC542 证书">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-5-w320.webp 320w" sizes="158px" alt="HPE ATP Server Solutions 证书">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
<!-- CV:BEGIN generated from assets/data/cv.json by _tooling/cv/build.py -- do not edit by hand -->
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="national-ai-platform" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2026年至今</p>
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">开发者 — 国家开源人工智能平台</p>
                                                <p class="timeline-desc text-black-56">国家开源人工智能平台开发者。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="ksf-ceo" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2013年12月至今</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">首席执行官 — Kohan System Farda（KSF）</p>
                                                <p class="timeline-desc text-black-56">领导人工智能产品、网络安全服务和企业基础设施，包括 Padyar、HomaYar、MeetYar 与 BlogYar。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="phd-it-management" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">博士 — 信息技术管理与智慧商业</p>
                                                <p class="timeline-desc text-black-56">伊斯兰阿扎德大学德黑兰中央分校 · 平均成绩 17.70/20。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="modaberan" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2018年7月 - 2024年2月</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">高级网络与系统工程师 — Modaberan Fanavari Pasargad</p>
                                                <p class="timeline-desc text-black-56">企业网络、网络安全产品、备份、VMware、存储与技术支持。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="saba-safe-village" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">兼职讲师 — Saba Safe Village</p>
                                                <p class="timeline-desc text-black-56">讲授 Backup Exec、网络安全与基础设施课程。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="haft-tappeh" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">高级网络与系统工程师 — Haft Tappeh Sugarcane Agro-Industry</p>
                                                <p class="timeline-desc text-black-56">负责 IT 基础设施、虚拟化、企业网络、安全监控与自动化。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="msc-it-management" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">硕士 — 信息技术管理与电子商务</p>
                                                <p class="timeline-desc text-black-56">德黑兰大学 · 平均成绩 15.97/20。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="golzar-ettesal" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">高级网络工程师 — Golzar Ettesal</p>
                                                <p class="timeline-desc text-black-56">提供企业网络、基础设施与技术支持服务。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="azad-university" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">高级网络与互联网专家 — 伊斯兰阿扎德大学</p>
                                                <p class="timeline-desc text-black-56">管理德黑兰中央分校的网络和互联网服务。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="power-control" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">网络与系统工程师 — Power Control Engineering</p>
                                                <p class="timeline-desc text-black-56">设计、维护并支持计算机网络和系统。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="mca-computer-software" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">MCA — 计算机软件技术</p>
                                                <p class="timeline-desc text-black-56">马什哈德费尔多西大学 · 平均成绩 16.72/20。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="negareh" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">网络工程师 — Negareh Information Analysts</p>
                                                <p class="timeline-desc text-black-56">为企业客户提供存储、备份、网络监控与系统支持。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="best-design" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">兼职 IT 专员 — Best Design</p>
                                                <p class="timeline-desc text-black-56">为室内设计工作站、办公系统和网络提供支持。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="novin-gostar-aysa" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">网络工程师 — Novin Gostar-e Aysa</p>
                                                <p class="timeline-desc text-black-56">安装、配置并维护网络和计算机系统。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="culham" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">网络与系统工程师 — Culham Engineering</p>
                                                <p class="timeline-desc text-black-56">支持办公室运营、计算机网络和系统。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="associate-computer-software" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">副学士 — 计算机软件工程</p>
                                                <p class="timeline-desc text-black-56">伊斯兰阿扎德大学菲鲁兹库分校 · 2009年7月完成。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="amen-behin" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">硬件与网络专家 — Amen Behin System</p>
                                                <p class="timeline-desc text-black-56">提供计算机硬件、网络和系统支持。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- CV:END -->
                            ...
                            <div id="tech" class="section-tech-stack flat-spacing">
                                ...
                                <ul class="tech-list">
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image">
                                                <img loading="lazy" width="29" height="28" src="<?php echo KDCV; ?>/assets/images/section/tech-4.svg?v=2026091701" alt="量子就绪咨询图标">
                                            </div>
                                            <div class="tech_info">
                                                <p class="info__name fw-medium text-black-72">量子就绪咨询</p>
                                                <p class="info__duty text-black-56 text-body-3">密码资产盘点与向 NIST 后量子标准迁移
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech" data-tech-brand="arctera">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark"><img loading="lazy" width="160" height="43" src="<?php echo KDCV; ?>/assets/images/section/tech-arctera.svg?v=2026091701" alt="Arctera 标志"></div>
                                            <div class="tech_info">
                                    ...
                                    <li class="wg-tech" data-tech-brand="veritas">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark"><img loading="lazy" width="24" height="24" src="<?php echo KDCV; ?>/assets/images/section/tech-veritas.svg?v=2026091701" alt="Veritas 标志"></div>
                                            <div class="tech_info">
