...
<head>
  ...
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    ...
    <link rel="alternate" type="text/plain" title="llms.txt" href="https://kohandezh.com/llms.txt">
  <link rel="alternate" type="application/rss+xml" title="Mohammad Ali Kohandezh — Selected writing" href="/feed.xml">
                        ...
                        <div class="wrap-container">
                                ...
                                <div class="infiniteSlide-brand eco-marquee">
                                    ...
                                    <a href="https://blogyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">AI editorial team for WordPress</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                            ...
                            <div id="about" class="section-about flat-spacing">
                                ...
                                <p class="s-desc text-black-56 scrolling-effect effectTop">
                                    ...
                                    <br>
                                    As CEO of Kohan System Farda (KSF) and holder of a PhD in IT Management, <br class="d-none d-lg-block">
                                ...
                                <ul class="award-list">
                                    <li class="award-item hover-cursor-img">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-1-w320.webp 320w" sizes="158px" alt="VMware VCP-DCV 2021 certificate">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-2-w320.webp 320w" sizes="158px" alt="CEH certificate">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-3-w320.webp 320w" sizes="158px" alt="CHFI certificate">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-4-w320.webp 320w" sizes="158px" alt="SEC504 certificate">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-6-w320.webp 320w" sizes="158px" alt="SEC542 certificate">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-5-w320.webp 320w" sizes="158px" alt="HPE ATP Server Solutions certificate">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
<!-- CV:BEGIN generated from assets/data/cv.json by _tooling/cv/build.py -- do not edit by hand -->
                                    ...
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="ksf-ceo" data-cv-type="work">
                                        <p class="timeline-date text-black-56">Dec 2013 - Present</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                            ...
                            <div id="tech" class="section-tech-stack flat-spacing">
                                ...
                                <ul class="tech-list">
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image">
                                                <img loading="lazy" width="29" height="28" src="<?php echo KDCV; ?>/assets/images/section/tech-4.svg?v=2026091701" alt="Quantum readiness advisory icon">
                                            </div>
                                            <div class="tech_info">
                                    ...
                                    <li class="wg-tech" data-tech-brand="veritas">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark">
                                                <img loading="lazy" width="24" height="24" src="<?php echo KDCV; ?>/assets/images/section/tech-veritas.svg?v=2026091701" alt="Veritas logo">
                                            </div>
                                            <div class="tech_info">
