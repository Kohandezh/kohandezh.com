<?php /* KohandezhCV — front page (English CV) (generated by sync-from-static.py, do not hand-edit) */ ?>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr" data-kdcv-router-mode="wordpress" data-kdcv-site-base="<?php echo esc_url(home_url('/')); ?>">
...
<head>
  ...
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
    ...
    <link rel="stylesheet" href="<?php echo KDCV; ?>/assets/css/glowing-effect.min.css?v=105" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="<?php echo KDCV; ?>/assets/css/glowing-effect.min.css?v=105"></noscript>
  ...
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    ...
    <!-- SEO: canonical -->
    <link rel="canonical" href="https://kohandezh.com/">
...
<script>/* Theme boot — runs before paint so a page never flashes the wrong theme on navigation. Mirrors main.js: stored choice wins, then data-default-mode, then light. `light` is the class portfolio.js uses. */(function(){try{var s=localStorage.getItem("darkMode"),d;if(s!==null){d=s==="enabled";}else{d=document.body.getAttribute("data-default-mode")==="dark";}document.body.classList.toggle("dark-mode",d);document.body.classList.toggle("light",!d);document.documentElement.setAttribute("data-kdcv-theme",d?"dark":"light");}catch(e){}})();</script>
  <a class="kd-skip-link" href="#wrapper">Skip to content</a>
    ...
    <div class="tf-left-bar">
        <a class="btn-setting-color tf-btn-icon style-2" data-bs-toggle="offcanvas" href="#languageMenu" aria-label="Choose language"><span class="language-button-label" aria-hidden="true">EN</span></a>
    </div>
    <!-- /Btn Open Language -->
    <!-- Language Menu -->
    <div class="offcanvas offcanvas-end offcanvas-color" id="languageMenu">
        <div class="offcanvas-content">
            <div class="canvas-header">
                <h5 class="letter-space--2">Language</h5>
                <span class="icon-close-popup" data-bs-dismiss="offcanvas">
                    <i class="icon-close"></i>
                </span>
            </div>
            <div class="canvas-body">
                <h6 class="title">Choose language</h6>
                <div class="settings-color list-choose lang-list">
                    <button type="button" class="btn-color choose-item lang-item is-active" data-lang="en" data-dir="ltr">
                ...
                <p class="text-body-3 text-black-56" style="margin-top:16px;">
                    Choose a language to view the profile, CV and contact options in your preferred language.
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Menu Mobile -->
    <div class="action-open-mobile d-lg-none" role="button" tabindex="0" aria-label="Open navigation menu" aria-expanded="false">
            ...
            <ul class="nav-mobile-item">
                ...
                <li class="nav-item">
                    <a href="#certificates" class="item-link scroll-link">
                        ...
                        <p class="tool-tip text-caption">Certificates</p>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#blog" class="item-link scroll-link">
                        ...
                        <p class="tool-tip text-caption">Blog</p>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <div class="sidebar-user">
            <div class="wrap">
                ...
                <ul class="tf-social-icon-2 user-social d-grid">
                    ...
                    <li><a href="https://ksf.ir" target="_blank" rel="noopener" aria-label="Visit KSF">
                    ...
                    <li><a href="<?php echo esc_url( home_url('/psn/') ); ?>" class="psn-profile-link" aria-label="View Mohammad Ali Kohandezh's PlayStation trophies">
                    ...
                    <li><a href="<?php echo esc_url( home_url('/certificates/') ); ?>?lang=en" class="certificate-profile-link" aria-label="Open certificate archive"><i class="icon icon-edu" aria-hidden="true"></i></a></li>
                </ul>
                <div class="user-info">
                    <h5 class="greeting letter-space--2 text-white animationtext clip">
                        ...
                        <span class="cd-words-wrapper">
                            ...
                            <span class="item-text is-hidden">IT Strategist</span>
                            <span class="item-text is-hidden">CEO of KSF</span>
                        </span>
                    </h5>
                    <p class="introduce text-white-56 letter-space--05 text-body-3">
                        I help enterprises build secure, resilient IT
                        infrastructure, based in Tehran, Iran — working out of
                        TechElite, the Nokhbegan Technology Growth Center
                    ...
                    <div class="action-group">
                        ...
                        <a href="<?php echo KDCV; ?>/assets/contact/Mohammad-Kohandezh-CV-ATS-EN.pdf" download class="action-down">
                        ...
                        <div class="wrap-container">
                            ...
                            <div id="home" class="section-intro flat-spacing">
                                <div class="intro-author effectFade fadeUp no-div">
                                    ...
                                    <div class="author-info letter-space--05">
                                        ...
                                        <p class="info_duty text-black-50 text-body-3">AI, Cybersecurity &amp; IT Infrastructure Specialist
                                        </p>
                                    </div>
                                </div>
                                <h1 class="intro-title letter-space--2 split-text effect-blur-fade">
                                    ...
                                    <span class="type-2">&amp; secure infrastructure</span>
                                ...
                                <div class="infiniteSlide-brand eco-marquee">
                                    ...
                                    <span class="eco-tag">AI workflow and assistant product</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://netyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">Another AI product from the KSF ecosystem</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://kohansystemfarda.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">Official company site</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                            ...
                            <div id="about" class="section-about flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                    Building AI products and <br class="d-none d-lg-block">
                                    secure infrastructure with <br class="d-none d-lg-block">
                                    professional practice since 2007
                                </h2>
                                <p class="s-desc text-black-56 scrolling-effect effectTop">
                                    I design and build AI-driven products — including the Padyar AI assistant<br class="d-none d-lg-block">
                                    platform, an AI Agent platform, and the HomaYar, MeetYar, BlogYar, NetYar and HomeYar products — alongside <br>
                                    enterprise IT infrastructure, virtualization and cybersecurity. <br>
                                    <br>
                                ...
                                <div class="professional-roles">
                                    ...
                                    <ul class="professional-roles__list">
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">Chair, Cybersecurity Committee</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">IoT and Data Science NGO</p>
                                            </div>
                                            <span class="professional-role__badge">Leadership</span>
                                        </li>
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">Coordinator, Nehzate Noor va Danesh Volunteer Group</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">Nehzate Noor va Danesh</p>
                                            </div>
                                            <span class="professional-role__badge">Community Service</span>
                                        </li>
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">Member, AI &amp; Data Science, Network &amp; IoT Commissions</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">Iranian ICT Guild (IranNSR)</p>
                                            </div>
                                            <span class="professional-role__badge">Professional Membership</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="certificates" class="section-about flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                    Certifications backing the work above
                                </h2>
                                <ul class="award-list">
                            ...
                            <div id="work" class="section-work flat-spacing">
                                ...
                                <div class="work-list element-sticky">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-top">
                                                            ...
                                                            <p class="w-tagline text-white-72 text-body-2 fw-medium" style="letter-spacing:.04em">
                                                                “We Design Your Digital Life”
                                                            </p>
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                My holding company — spanning IT infrastructure,
                                                                AI products
                                                                and cybersecurity
                                                                consulting
                                                            </p>
                                                ...
                                                <div class="work-content">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-top">
                                                            ...
                                                            <h3 class="w-title letter-space--2 text-white-72">
                                                                Padyar — AI Avatar Platform
                                                            </h3>
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                An AI avatar platform — giving organizations a
                                                                human face for
                                                                their AI, with natural voice synthesis
                                                            </p>
                                                            <div class="w-highlight">
                                                                <div class="box-high">
                                                                    <p class="text-body-3 text-white-56">
                                    ...
                                    <div class="sticky-item">
                                        <div class="wg-work">
                                            <div class="work-image">
                                                <img loading="lazy" width="1600" height="900" src="<?php echo KDCV; ?>/assets/images/section/work-homayar-localized.webp" alt="Homayar.com product preview">
                                            </div>
                                            <div class="wrap">
                                                <div class="work-content">
                                                    <div class="w-image">
                                                        <img loading="lazy" width="468" height="856" src="<?php echo KDCV; ?>/assets/images/section/work-homayar-localized.webp"
                                                            alt="Homayar.com product preview">
                                                    </div>
                                                    <div class="content">
                                                        <div class="content-top">
                                                            <div class="w-logo">
                                                            ...
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                An AI workflow and assistant product from the Kohan
                                                                System Farda technology ecosystem
                                                            </p>
                                                            <div class="w-highlight">
                                                                <div class="box-high">
                                                                    <p class="text-body-3 text-white-56">
                                ...
                                <div class="work-cta effectFade fadeUp no-div">
                                    <div>
                                        <h3 class="h5 letter-space--2 text-black-72">Have a project in mind?</h3>
                                        <p class="text-body-3 text-black-56">Tell me about your infrastructure, security or AI challenge — I reply personally within one business day.</p>
                                    </div>
                                    <a href="#contact" class="tf-btn-action">
                                        <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                        <span class="text text-body-3 letter-space--05 fw-medium">Request collaboration</span>
                                        <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                    </a>
                                </div>
                            <!-- /Work Highlight -->
                                ...
                                <div class="" id="accordion-service">
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-ai" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">Artificial Intelligence &amp; Smart Automation</h3>
                                            <div class="ic-wrap">
                                        ...
                                        <div id="service-ai" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                <div class="tf-grid-layout sm-col-2 lg-col-3">
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-padyar-localized.webp" alt="Padyar enterprise AI avatar platform">
                                                        </div>
                                                    </div>
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-homayar-localized.webp" alt="Homayar AI call analytics platform">
                                                        </div>
                                                    </div>
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-ksf-localized.webp" alt="KSF enterprise AI solutions">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="service-tag">
                                                    <a href="#service" class="tag-item text-body-3 fw-medium text-black-72 link">
                                                        Enterprise AI Avatar (Padyar)
                                                    </a>
                                                    <a href="#service" class="tag-item text-body-3 fw-medium text-black-72 link">
                                                        AI Call Analytics (Homayar)
                                                    </a>
                                                    <a href="#service" class="tag-item text-body-3 fw-medium text-black-72 link">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    Design and deployment of enterprise AI — from talking avatars and digital twins
                                                    to call-quality analytics and AI-agent process automation, on-premises or in the cloud.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-1" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">Infrastructure &amp; Virtualization</h3>
                                            <div class="ic-wrap">
                                                <span class="ic-accordion-custom"></span>
                                            </div>
                                        </div>
                                        <div id="service-1" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    I design and operate enterprise datacenters — virtualization,
                                                    servers and storage — built
                                                    for performance, availability and growth.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        ...
                                        <div id="service-2" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    Enterprise backup and disaster-recovery solutions with Arctera Backup Exec,
                                                    Veeam and Veritas NetBackup — protecting critical
                                                    data with tested restore and replication plans.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-3" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">Cybersecurity &amp; Forensics</h3>
                                            <div class="ic-wrap">
                                                <span class="ic-accordion-custom"></span>
                                            </div>
                                        </div>
                                        <div id="service-3" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    Security assessment, hardening and incident response backed by
                                                    CEH, CHFI and security-training experience —
                                                    keeping your organization safe and audit-ready.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <ul class="tech-list">
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">Enterprise virtualization</p>
                                            </div>
                                        </div>
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">Data protection &amp; recovery
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                <p class="info__name fw-medium text-black-72">Windows Server &amp; Security</p>
                                                <p class="info__duty text-black-56 text-body-3">HPE ATP, CEH and security training
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech" data-tech-brand="arctera">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">Backup, recovery and disaster-recovery operations</p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech" data-tech-brand="veritas">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark">
                                                <img loading="lazy" width="24" height="24" src="<?php echo KDCV; ?>/assets/images/section/tech-veritas.svg?v=1" alt="Veritas logo">
                                            </div>
                                            <div class="tech_info">
                                                <p class="info__name fw-medium text-black-72">Veritas NetBackup</p>
                                                <p class="info__duty text-black-56 text-body-3">Enterprise backup and recovery at scale</p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                            <div class="progress-line" data-progress="85">
                            ...
                            <div id="blog" class="section-blog flat-spacing">
                                ...
                                <div class="blog-local-list" data-kdcv-blog-feed data-loaded="<?php echo esc_attr( min( 6, (int) wp_count_posts( 'post' )->publish ) ); ?>" data-read-label="Read original">
                                    <?php echo kdcv_render_home_blog_feed( 'Read original', 6 ); ?>
                                </div>
                                <a href="<?php echo esc_url( home_url('/blog/') ); ?>" class="tf-btn-action" style="margin-top:24px;">
                                    <span class="text text-body-3 letter-space--05 fw-medium">Open full blog archive</span>
                                    <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                </a>
                            </div>
                            <!-- /Blog -->
                            ...
                            <div id="testimonial" class="section-testimonial flat-spacing">
                                ...
                                <div class="heading overflow-hidden">
                                    <div class="head-left">
                                        <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                            Here's what <br class="d-none d-lg-block">
                                            people are saying
                                        </h2>
                                        <div class="box-counter effectFade fadeUp no-div">
                                            <div class="wg-counter">
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-v01">
                                                    ...
                                                    <h5 class="tes-text letter-space--2 text-black-72">
                                                        Our virtualization platform was redesigned end to end —
                                                        stable, documented, and
                                                        maintainable
                                                        by our own team.
                                                    </h5>
                                                    <div class="tes-author">
                                                        <p class="author_name fw-medium text-black-72">IT Manager</p>
                                                        <p class="text-body-3 text-black-56">Banking sector
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-v01">
                                                    ...
                                                    <h5 class="tes-text letter-space--2 text-black-72">
                                                        When ransomware hit, the recovery plan he had built worked
                                                        exactly as designed — we were
                                                        back online with zero data loss.
                                                    </h5>
                                                    <div class="tes-author">
                                                        <p class="author_name fw-medium text-black-72">Infrastructure Lead</p>
                                                        <p class="text-body-3 text-black-56">Enterprise client
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-v01">
                                                    ...
                                                    <h5 class="tes-text letter-space--2 text-black-72">
                                                        His security assessment found what two previous audits had
                                                        missed — and the hardening
                                                        roadmap was practical, not theoretical.
                                                    </h5>
                                                    <div class="tes-author">
                                                        <p class="author_name fw-medium text-black-72">CISO
                                                        </p>
                                                        <p class="text-body-3 text-black-56">Financial services
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div id="demo" class="section-demo flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 split-text effect-blur-fade">
                                    Talk to Dr. Kohandezh directly, or <br class="d-none d-lg-block">
                                    to his AI avatar &amp; digital twin
                                </h2>
                                <div class="demo-mode-toggle" role="tablist" aria-label="Demo type">
                                    <button type="button" class="demo-mode-btn is-active" data-mode="human" role="tab" aria-selected="true">
                                        ...
                                        <span>Talk to Dr. Kohandezh</span>
                                    </button>
                                    <button type="button" class="demo-mode-btn" data-mode="avatar" role="tab" aria-selected="false">
                                        ...
                                        <span>Talk to the AI Avatar</span>
                                    </button>
                                </div>
                                <p class="demo-mode-note" data-mode-note="human">A live conversation with Mohammad Ali Kohandezh — for strategic, executive-level or technical discussions.</p>
                                <p class="demo-mode-note" data-mode-note="avatar" hidden>A guided conversation with Dr. Kohandezh's AI avatar and digital twin, trained on his expertise and available anytime. Leave your details and we'll send you the session link.</p>
                                <form class="form-contact form-demo" id="demoform" action="https://api.web3forms.com/submit" method="POST">
                                    ...
                                    <input type="hidden" name="contact_mode" id="demo-mode-field" value="Talk to Dr. Kohandezh">
                                    ...
                                    <div class="form-content effectFade fadeUp no-div">
                                        <fieldset class="field-ip">
                                            <input type="text" name="name" id="demo-name" placeholder="Your Name *" required>
                                        </fieldset>
                                        <fieldset class="field-ip">
                                            <input type="email" name="email" id="demo-email" placeholder="Email Address *" required>
                                        </fieldset>
                                        <fieldset class="field-ip">
                                            <input type="tel" name="phone" id="demo-phone" placeholder="Phone / WhatsApp *" required inputmode="tel" autocomplete="tel" pattern="[0-9+\(\)\s\-]{6,}">
                                        </fieldset>
                                        <fieldset class="field-ip">
                                            <input type="text" name="company" id="demo-company" placeholder="Company / Organization">
                                        </fieldset>
                                        <fieldset class="field-ip">
                                            <select name="field_of_interest" id="demo-field" required>
                                                <option value="" disabled selected>What do you need? *</option>
                                                <option value="AI Consulting">AI Consulting</option>
                                                <option value="AI Services &amp; Implementation">AI Services &amp; Implementation</option>
                                        ...
                                        <fieldset class="field-ip">
                                            <textarea name="message" id="demo-message" placeholder="Briefly, what would you like to discuss?"></textarea>
                                        </fieldset>
                                    </div>
                                    <div class="form-action effectFade fadeUp no-div">
                                        <div class="send-wrap">
                                            <button type="submit" class="tf-btn animate-btn animate-dark">
                                                <span class="text-body-3" data-mode-cta="human">Request a Call</span>
                                                <span class="text-body-3" data-mode-cta="avatar" hidden>Talk to the AI Avatar</span>
                                            </button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form class="form-contact" id="contactform" action="https://api.web3forms.com/submit" method="POST"
                                   >
                                    ...
                                    <div class="form-content effectFade fadeUp no-div">
                                        ...
                                        <fieldset class="field-ip">
                                            <input type="tel" name="phone" id="phone" placeholder="Phone Number *" required inputmode="tel" autocomplete="tel" pattern="[0-9+\(\)\s\-]{6,}">
                                        </fieldset>
                                        <fieldset class="field-ip">
                                            <textarea name="message" id="message" required placeholder="Project Description *"></textarea>
                                        </fieldset>
                                    </div>
                                    <p class="kdcv-form-note">All fields marked * are required.</p>
                                    <div class="form-action effectFade fadeUp no-div">
                                        <div class="send-wrap">
                                            <button type="submit" class="tf-btn animate-btn animate-dark">
                                                <span class="text-body-3">
                                ...
                                <div class="contact-schedule">
                                    ...
                                    <div class="schedule-embed" data-booking-url="">
                                        ...
                                        <div class="schedule-fallback">
                                            <p>Online booking is being set up. In the meantime, email directly and a Google Meet link will be sent.</p>
                                            <a href="mailto:Kohandezh@hotmail.com" class="tf-btn-action"><span class="text text-body-3 fw-medium">Email to schedule</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <noscript>
        ...
        <section class="linkedin-noscript" aria-labelledby="linkedin-noscript-title">
            <h2 id="linkedin-noscript-title">LinkedIn recommendations &amp; activity</h2>
            <p>Original recommendations and activity links from Mohammad Ali Kohandezh’s public LinkedIn record.</p>
            <ul>
            ...
            <ul>
                <li><a href="https://www.linkedin.com/feed/update/urn:li:activity:7388299488152424448/" target="_blank" rel="noopener noreferrer">GITEX 2025 — an analytical look at global technology innovation</a> · <time datetime="2025-10-26">Oct 26, 2025</time></li>
                <li><a href="https://www.linkedin.com/feed/update/urn:li:activity:7382455627651919872/" target="_blank" rel="noopener noreferrer">Expand North Star — the world’s largest startup event</a> · <time datetime="2025-10-10">Oct 10, 2025</time></li>
            </ul>
        </section>
    </noscript>
