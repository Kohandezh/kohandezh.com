<?php /* KohandezhCV — CV page, auto-applied to page slug 'ja' (generated by sync-from-static.py, do not hand-edit) */ ?>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja" dir="ltr" data-kdcv-router-mode="wordpress" data-kdcv-site-base="<?php echo esc_url(home_url('/')); ?>">
...
<head>
  ...
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
    ...
    <style>
        ...
        .schedule-fallback p {
            ...
            /* Japanese typography: Inter for Latin + standard system JP stack */
        body, h1, h2, h3, h4, h5, h6, p, a, span, li, div, blockquote, figcaption,
        button, input, select, textarea {
            font-family: "Inter", "Hiragino Kaku Gothic ProN", "Hiragino Sans", "Yu Gothic UI", "Meiryo", "Noto Sans JP", sans-serif !important;
        }
  ...
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    ...
    <!-- SEO: canonical -->
    <link rel="canonical" href="<?php echo esc_url( home_url('/ja/') ); ?>">
    ...
    <link rel="alternate" type="text/plain" title="llms.txt" href="https://kohandezh.com/ja-llms.txt">
  <link rel="alternate" type="application/rss+xml" title="Mohammad Ali Kohandezh — 選りすぐりの記事" href="/feed.xml">
    ...
    <meta property="og:url" content="https://kohandezh.com/ja/">
    <meta property="og:title" content="モハンマド・アリ・コハンデジュ - AI・サイバーセキュリティ・ITインフラ専門家">
    <meta property="og:description" content="モハンマド・アリ・コハンデジュ — IT経営学博士、Kohan System Farda（KSF）CEO。2007年以来、AI、エンタープライズITインフラ、仮想化、バックアップ＆リカバリ、サイバーセキュリティの分野で活動。">
    ...
    <meta name="twitter:title" content="モハンマド・アリ・コハンデジュ - AI・サイバーセキュリティ・ITインフラ専門家">
  ...
  <script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "ProfilePage",
  "@id": "https://kohandezh.com/ja/#profilepage",
  "url": "https://kohandezh.com/ja/",
  "inLanguage": "ja",
...
<script>/* Theme boot — runs before paint so a page never flashes the wrong theme on navigation. Mirrors main.js: stored choice wins, then data-default-mode, then light. `light` is the class portfolio.js uses. */(function(){try{var s=localStorage.getItem("darkMode"),d;if(s!==null){d=s==="enabled";}else{d=document.body.getAttribute("data-default-mode")==="dark";}document.body.classList.toggle("dark-mode",d);document.body.classList.toggle("light",!d);document.documentElement.setAttribute("data-kdcv-theme",d?"dark":"light");}catch(e){}})();</script>
  <a class="kd-skip-link" href="#wrapper">本文へスキップ</a>
    ...
    <div class="tf-left-bar">
        <a class="btn-setting-color tf-btn-icon style-2" data-bs-toggle="offcanvas" href="#languageMenu" aria-label="言語を選択"><span class="language-button-label" aria-hidden="true">JA</span></a>
    </div>
    <!-- /Btn Open Language -->
    <!-- Language Menu -->
    ...
    <!-- Menu Mobile -->
    <div class="action-open-mobile d-lg-none" role="button" tabindex="0" aria-label="ナビゲーションメニューを開く" aria-expanded="false">
            ...
            <ul class="nav-mobile-item">
                <li class="nav-item">
                    <a href="#home" class="item-link scroll-link">
                        ...
                        <p class="tool-tip text-caption">ホーム</p>
                    </a>
                </li>
                <li class="br-line"></li>
                <li class="nav-item">
...
<ul class="tf-social-icon-2 user-social d-grid">
                    ...
                    <li><a href="<?php echo esc_url( home_url('/psn/') ); ?>" class="psn-profile-link" aria-label="PlayStationトロフィーを見る">
                    ...
                    <li><a href="<?php echo esc_url( home_url('/certificates/') ); ?>?lang=ja" class="certificate-profile-link" aria-label="資格アーカイブを開く"><i class="icon icon-edu" aria-hidden="true"></i></a></li>
                ...
                <div class="user-info">
                    <h5 class="greeting letter-space--2 text-white animationtext clip">
                        ...
                        <span class="cd-words-wrapper">
                            ...
                            <span class="item-text is-hidden">ITストラテジスト</span>
                            <span class="item-text is-hidden">KSFのCEO</span>
                        </span>
                    </h5>
                    <p class="introduce text-white-56 letter-space--05 text-body-3">
                        イランのテヘランを拠点に、企業向けの安全でレジリエントなITインフラ構築を支援しています。パルディス・テクノロジーパークのTechElite（ヌフベガーン技術成長センター、Masir 21）にオフィスを構えています。
                    </p>
                    ...
                    <div class="action-group">
                        ...
                        <a href="<?php echo KDCV; ?>/assets/contact/Mohammad-Kohandezh-CV-ATS-JA.pdf" download class="action-down" aria-label="履歴書をダウンロード">
                        ...
                        <div class="wrap-container">
                            ...
                            <div id="home" class="section-intro flat-spacing">
                                ...
                                <h1 class="intro-title letter-space--2 split-text effect-blur-fade">
                                    ...
                                    <span class="type-2">と安全なインフラを</span>
                                    構築しています
                                </h1>
                                ...
                                <div class="infiniteSlide-brand eco-marquee">
                                    ...
                                    <a href="https://padyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">AIアシスタントプラットフォーム</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    ...
                                    <span class="eco-tag">AIワークフロー＆アシスタント製品</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://netyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">KSFエコシステムのAI製品</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://kohansystemfarda.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">公式企業サイト</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                                    <a href="https://blogyar.com" target="_blank" rel="noopener" class="eco-card">
                                        <span class="eco-text">
                                            ...
                                            <span class="eco-tag">WordPress のための AI 編集チーム</span>
                                        </span>
                                        <i class="icon icon-arrow-right-top"></i>
                                    </a>
                            ...
                            <div id="about" class="section-about flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                    AI製品と <br class="d-none d-lg-block">
                                    安全なインフラを <br class="d-none d-lg-block">
                                    2007年から実務として構築
                                </h2>
                                <p class="s-desc text-black-56 scrolling-effect effectTop">
                                    Padyar AIアシスタントプラットフォームやAIエージェント基盤、<br class="d-none d-lg-block">
                                    HomaYar、MeetYar、BlogYar、NetYar、HomeYarなどのAI製品を設計・開発するとともに、 <br>
                                    エンタープライズITインフラ、仮想化、サイバーセキュリティにも取り組んでいます。 <br>
                                    <br>
                                    Kohan System Farda（KSF）のCEOとして、IT経営学の博士号を持ち、 <br class="d-none d-lg-block">
                                    すべてのプロジェクトに、エンジニアリングの厳密さとビジネスの洞察の両面から向き合います。また、企業の量子対応（クオンタム・レディネス）についても助言しています——暗号インベントリの作成、データ保持期間の分析、そして NIST ポスト量子標準への移行計画までを支援します。
                                </p>
                                <div class="professional-roles">
                                    ...
                                    <ul class="professional-roles__list">
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">サイバーセキュリティ委員会 委員長</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">IoT・データサイエンスNGO</p>
                                            </div>
                                            <span class="professional-role__badge">リーダーシップ</span>
                                        </li>
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">Nehzate Noor va Danesh ボランティアグループ コーディネーター</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">Nehzate Noor va Danesh</p>
                                            </div>
                                            <span class="professional-role__badge">社会貢献</span>
                                        </li>
                                        <li class="professional-role">
                                            <div>
                                                <h4 class="h6 professional-role__title letter-space--05 text-black-72">AI・データサイエンス、ネットワーク・IoT委員会 会員</h4>
                                                <p class="professional-role__org text-body-3 text-black-56">イランICT組合（IranNSR）</p>
                                            </div>
                                            <span class="professional-role__badge">専門会員</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="certificates" class="section-about flat-spacing">
                                ...
                                <ul class="award-list">
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">VCP-DCV 2021 — データセンター仮想化</h3>
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-1-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-1-w320.webp 320w" sizes="158px" alt="VMware VCP-DCV 2021 認定証">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">CEH — 認定エシカルハッカー</h3>
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-2-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-2-w320.webp 320w" sizes="158px" alt="CEH 認定証">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">CHFI — コンピュータフォレンジック調査員
                                            </h3>
                                            <p class="award_desc text-black-56">SABA Safe Village</p>
                                        </div>
                                        <h4 class="h6 award_year text-black-72">
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-3-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-3-w320.webp 320w" sizes="158px" alt="CHFI 認定証">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">SEC504 — ハッカー技術トレーニング</h3>
                                            <p class="award_desc text-black-56">SABA Safe Village</p>
                                        </div>
                                        <h4 class="h6 award_year text-black-72">
                                            侵入テスト
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-4-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-4-w320.webp 320w" sizes="158px" alt="SEC504 認定証">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">SEC542 — Webアプリ・ペネトレーションテスト研修</h3>
                                            <p class="award_desc text-black-56">SABA Safe Village</p>
                                        </div>
                                        <h4 class="h6 award_year text-black-72">
                                            侵入テスト
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-6-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-6-w320.webp 320w" sizes="158px" alt="SEC542 認定証">
                                        </div>
                                    </li>
                                    <li class="award-item hover-cursor-img">
                                        <div class="left">
                                            <h3 class="h6 award_name letter-space--2 text-black-72">HPE公認テクニカルプロフェッショナル — サーバーソリューションV4</h3>
                                        ...
                                        <div class="award_img hover-image">
                                            <img loading="lazy" width="158" height="224" style="object-fit:cover" src="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp" srcset="<?php echo KDCV; ?>/assets/images/section/award-5-w160.webp 160w, <?php echo KDCV; ?>/assets/images/section/award-5-w320.webp 320w" sizes="158px" alt="HPE ATP Server Solutions 認定証">
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
<!-- CV:BEGIN generated from assets/data/cv.json by _tooling/cv/build.py -- do not edit by hand -->
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="national-ai-platform" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2026 - 現在</p>
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">開発者 — 国立オープンソースAIプラットフォーム</p>
                                                <p class="timeline-desc text-black-56">国立オープンソースAIプラットフォームの開発者。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="ksf-ceo" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2013年12月 - 現在</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="timeline-desc text-black-56">Padyar、HomaYar、MeetYar、BlogYarを含むAI製品、サイバーセキュリティ、企業インフラを統括。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="phd-it-management" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">博士号 — IT経営学・スマートビジネス</p>
                                                <p class="timeline-desc text-black-56">イスラム・アザド大学テヘラン中央校 · GPA 17.70/20。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="modaberan" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">シニアネットワーク・システムエンジニア — Modaberan Fanavari Pasargad</p>
                                                <p class="timeline-desc text-black-56">企業ネットワーク、サイバーセキュリティ製品、バックアップ、VMware、ストレージ、技術サポートを担当。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="saba-safe-village" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2018年 - 2019年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-3_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-3.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">非常勤講師 — Saba Safe Village</p>
                                                <p class="timeline-desc text-black-56">Backup Exec、サイバーセキュリティ、インフラ研修を担当。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="haft-tappeh" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2016年 - 2018年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-3_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-3.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">シニアネットワーク・システムエンジニア — Haft Tappeh Sugarcane Agro-Industry</p>
                                                <p class="timeline-desc text-black-56">IT基盤、仮想化、社内ネットワーク、セキュリティ監視、自動化を担当。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="msc-it-management" data-cv-type="education">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">修士号 — IT経営学・eビジネス</p>
                                                <p class="timeline-desc text-black-56">テヘラン大学 · GPA 15.97/20。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="golzar-ettesal" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2015年 - 2016年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-3_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-3.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">シニアネットワークエンジニア — Golzar Ettesal</p>
                                                <p class="timeline-desc text-black-56">企業ネットワーク、インフラ、技術サポートを担当。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="azad-university" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2014年 - 2016年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-3_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-3.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">シニアネットワーク・インターネット担当 — イスラム・アザド大学</p>
                                                <p class="timeline-desc text-black-56">テヘラン中央校のネットワークとインターネットサービスを管理。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="power-control" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2013年 - 2015年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-3_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-3.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">ネットワーク・システムエンジニア — Power Control Engineering</p>
                                                <p class="timeline-desc text-black-56">コンピュータネットワークとシステムの設計、保守、サポートを担当。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="mca-computer-software" data-cv-type="education">
                                        <p class="timeline-date text-black-56">2011年 - 2013年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-2_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-2.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">MCA — コンピュータソフトウェア技術</p>
                                                <p class="timeline-desc text-black-56">マシュハド・フェルドウスィー大学 · GPA 16.72/20。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="negareh" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">ネットワークエンジニア — Negareh Information Analysts</p>
                                                <p class="timeline-desc text-black-56">企業顧客向けにストレージ、バックアップ、ネットワーク監視、システムサポートを提供。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="best-design" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2010年 - 2011年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-3_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-3.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">非常勤ITスペシャリスト — Best Design</p>
                                                <p class="timeline-desc text-black-56">デザイン端末、オフィスシステム、ネットワークを支援。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="novin-gostar-aysa" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2009年 - 2011年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-3_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-3.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">ネットワークエンジニア — Novin Gostar-e Aysa</p>
                                                <p class="timeline-desc text-black-56">ネットワークとコンピュータシステムの導入、設定、保守を担当。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="culham" data-cv-type="work">
                                        <p class="timeline-date text-black-56">2009年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-3_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-3.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">ネットワーク・システムエンジニア — Culham Engineering</p>
                                                <p class="timeline-desc text-black-56">オフィス運用、コンピュータネットワーク、システムを支援。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="associate-computer-software" data-cv-type="education">
                                        <p class="timeline-date text-black-56">2007年 - 2009年</p>
                                        <div class="timeline-dot"></div>
                                        <div class="timeline-content">
                                            <div class="icon">
                                                <img class="image-switch" data-dark="<?php echo KDCV; ?>/assets/images/item/edu-2_dark.svg?v=2" width="29" height="32" src="<?php echo KDCV; ?>/assets/images/item/edu-2.svg?v=2" alt="" loading="lazy" decoding="async">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">準学士 — コンピュータソフトウェア工学</p>
                                                <p class="timeline-desc text-black-56">イスラム・アザド大学フィルズク校 · 2009年7月修了。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline-item effectFade fadeUp no-div" data-cv-id="amen-behin" data-cv-type="work">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="content">
                                                <p class="timeline-role fw-6">ハードウェア・ネットワーク専門家 — Amen Behin System</p>
                                                <p class="timeline-desc text-black-56">コンピュータハードウェア、ネットワーク、システムを支援。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- CV:END -->
                            ...
                            <div id="work" class="section-work flat-spacing">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-top">
                                                            ...
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                ITインフラ、AI製品、サイバーセキュリティコンサルティングを手がける私のホールディングス
                                                            </p>
                                                ...
                                                <div class="work-content">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-top">
                                                            ...
                                                            <h3 class="w-title letter-space--2 text-white-72">
                                                                Padyar — AIアバタープラットフォーム
                                                            </h3>
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                組織のAIに人間の顔を与えるAIアバタープラットフォーム。自然な音声合成に対応。
                                                            </p>
                                                            <div class="w-highlight">
                                                                <div class="box-high">
                                                                    <p class="text-body-3 text-white-56">
                                                ...
                                                <div class="work-content">
                                                    ...
                                                    <div class="content">
                                                        <div class="content-top">
                                                            ...
                                                            <p class="w-desc text-white-56 text-body-3">
                                                                Kohan System FardaテクノロジーエコシステムのAIワークフロー＆アシスタント製品
                                                            </p>
                                                            <div class="w-highlight">
                                                                <div class="box-high">
                                                                    <p class="text-body-3 text-white-56">
                                ...
                                <div class="work-cta effectFade fadeUp no-div">
                                    <div>
                                        <h3 class="h5 letter-space--2 text-black-72">プロジェクトのご相談はありますか？</h3>
                                        <p class="text-body-3 text-black-56">インフラ、セキュリティ、AIの課題をお聞かせください。1営業日以内に本人が直接ご返信します。</p>
                                    </div>
                                    <a href="#contact" class="tf-btn-action">
                                        <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                        <span class="text text-body-3 letter-space--05 fw-medium">協業のご依頼</span>
                                        <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                    </a>
                                </div>
                            <!-- /Work Highlight -->
                                ...
                                <div class="" id="accordion-service">
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-ai" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">人工知能とインテリジェント自動化</h3>
                                            <div class="ic-wrap">
                                        ...
                                        <div id="service-ai" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                <div class="tf-grid-layout sm-col-2 lg-col-3">
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-padyar-localized.webp" alt="Padyar 企業向けAIアバタープラットフォーム">
                                                        </div>
                                                    </div>
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-homayar-localized.webp" alt="Homayar AI通話分析プラットフォーム">
                                                        </div>
                                                    </div>
                                                    <div class="service-image">
                                                        <div class="wrap_image">
                                                            <img loading="lazy" decoding="async" width="340" height="206" src="<?php echo KDCV; ?>/assets/images/section/work-ksf-localized.webp" alt="KSF エンタープライズAIソリューション">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <p class="service-desc text-black-56">
                                                    エンタープライズAIの設計と導入 — 対話型アバターやデジタルツインから、
                                                    通話品質分析、AIエージェントによる業務自動化まで。
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-1" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">インフラと仮想化</h3>
                                            <div class="ic-wrap">
                                                <span class="ic-accordion-custom"></span>
                                            </div>
                                        </div>
                                        <div id="service-1" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    性能・可用性・拡張性を重視したエンタープライズデータセンター（仮想化・サーバー・ストレージ）を設計・運用します。
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-2" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">バックアップと災害復旧</h3>
                                            <div class="ic-wrap">
                                                <span class="ic-accordion-custom"></span>
                                            </div>
                                        </div>
                                        <div id="service-2" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    Arctera Backup Exec、Veeam、Veritas NetBackupによるエンタープライズバックアップ／災害復旧ソリューション。検証済みのリストア計画とレプリケーションで重要データを保護します。
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="service-accordion_item scrolling-effect effectBottom" role="presentation">
                                        <div class="accordion-action collapsed" data-bs-target="#service-3" role="button" data-bs-toggle="collapse"
                                            ...
                                            <h3 class="text letter-space--2 text-black-72">サイバーセキュリティとフォレンジック</h3>
                                            <div class="ic-wrap">
                                                <span class="ic-accordion-custom"></span>
                                            </div>
                                        </div>
                                        <div id="service-3" class="collapse" data-bs-parent="#accordion-service">
                                            <div class="accordion-content">
                                                ...
                                                <p class="service-desc text-black-56">
                                                    CEH・CHFI・セキュリティ研修の経験に基づく、セキュリティ診断・強化・インシデント対応。組織を安全かつ監査対応可能な状態に保ちます。
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <ul class="tech-list">
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">エンタープライズ仮想化</p>
                                            </div>
                                        </div>
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                ...
                                                <p class="info__duty text-black-56 text-body-3">データ保護と復旧
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            ...
                                            <div class="tech_info">
                                                <p class="info__name fw-medium text-black-72">Windows Serverとセキュリティ</p>
                                                <p class="info__duty text-black-56 text-body-3">HPE ATP・CEH・セキュリティ研修
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image">
                                                <img loading="lazy" width="29" height="28" src="<?php echo KDCV; ?>/assets/images/section/tech-4.svg?v=2026091701" alt="量子対応アドバイザリーのアイコン">
                                            </div>
                                            <div class="tech_info">
                                                <p class="info__name fw-medium text-black-72">量子対応アドバイザリー</p>
                                                <p class="info__duty text-black-56 text-body-3">暗号インベントリとNISTポスト量子標準への移行
                                                </p>
                                            </div>
                                        </div>
                                        <div class="tech-progress">
                                    ...
                                    <li class="wg-tech" data-tech-brand="arctera">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark"><img loading="lazy" width="160" height="43" src="<?php echo KDCV; ?>/assets/images/section/tech-arctera.svg?v=2026091701" alt="Arctera ロゴ"></div>
                                            <div class="tech_info">
                                                <p class="info__name fw-medium text-black-72">Arctera Backup Exec</p>
                                                <p class="info__duty text-black-56 text-body-3">バックアップ、復元、災害復旧の運用</p>
                                            </div>
                                        </div>
                                    ...
                                    <li class="wg-tech" data-tech-brand="veritas">
                                        <div class="tech-infor effectFade fadeUp no-div">
                                            <div class="tech_image tech_image--wordmark"><img loading="lazy" width="24" height="24" src="<?php echo KDCV; ?>/assets/images/section/tech-veritas.svg?v=2026091701" alt="Veritas ロゴ"></div>
                                            <div class="tech_info">
                                                <p class="info__name fw-medium text-black-72">Veritas NetBackup</p>
                                                <p class="info__duty text-black-56 text-body-3">大規模なエンタープライズ向けバックアップと復旧</p>
                                            </div>
                                        </div>
                            ...
                            <div id="blog" class="section-blog flat-spacing">
                                ...
                                <div class="blog-local-list" data-kdcv-blog-feed data-loaded="<?php echo esc_attr( min( 6, (int) wp_count_posts( 'post' )->publish ) ); ?>" data-read-label="原文を読む">
                                    <?php echo kdcv_render_home_blog_feed( '原文を読む', 6 ); ?>
                                </div>
                                <a href="<?php echo esc_url( home_url('/blog/') ); ?>" class="tf-btn-action" style="margin-top:24px;">
                                    <span class="text text-body-3 letter-space--05 fw-medium">ブログ一覧を見る</span>
                                    <span class="ic-wrap"><i class="icon icon-arrow-right-top"></i></span>
                                </a>
                            </div>
                            <!-- /Blog -->
                            ...
                            <div id="testimonial" class="section-testimonial flat-spacing">
                                ...
                                <div class="heading overflow-hidden">
                                    <div class="head-left">
                                        <h2 class="s-title letter-space--2 text-black-72 split-text effect-blur-fade">
                                            皆さまから <br class="d-none d-lg-block">
                                            いただいた声
                                        </h2>
                                        <div class="box-counter effectFade fadeUp no-div">
                                            <div class="wg-counter">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="testimonial-v01">
                                                    ...
                                                    <div class="tes-author">
                                                        ...
                                                        <p class="text-body-3 text-black-56">金融サービス
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div id="demo" class="section-demo flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 split-text effect-blur-fade">
                                    コハンデジュ博士と直接、または <br class="d-none d-lg-block">
                                    AIアバター＆デジタルツインと話す
                                </h2>
                                <div class="demo-mode-toggle" role="tablist" aria-label="デモの種類">
                                ...
                                <p class="demo-mode-note" data-mode-note="human">モハンマド・アリ・コハンデジュとのライブ対話。戦略・経営・技術に関するご相談に。</p>
                                <p class="demo-mode-note" data-mode-note="avatar" hidden>コハンデジュ博士の専門知識で学習したAIアバター＆デジタルツインとのガイド付き対話。いつでも利用可能です。連絡先をご記入いただければ、セッションのリンクをお送りします。</p>
                                    ...
                                    <div class="form-content effectFade fadeUp no-div">
                                        ...
                                        <fieldset class="field-ip">
                                            <select name="field_of_interest" id="demo-field" required>
                                                ...
                                                <option value="IT Infrastructure">ITインフラ</option>
                                                <option value="Cybersecurity">サイバーセキュリティ</option>
                                                <option value="Backup &amp; Disaster Recovery">バックアップと災害復旧</option>
                                    ...
                                    <div class="form-action effectFade fadeUp no-div">
                                        <div class="send-wrap">
                                            <button type="submit" class="tf-btn animate-btn animate-dark">
                                                <span class="text-body-3" data-mode-cta="human">通話をリクエスト</span>
                                                <span class="text-body-3" data-mode-cta="avatar" hidden>AIアバターと話す</span>
                                            </button>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div id="contact" class="section-contact flat-spacing">
                                ...
                                <h2 class="s-title letter-space--2 split-text effect-blur-fade">
                                    一般的なご質問やプロジェクトの <br class="d-none d-lg-block">
                                    ご相談は、メールまたは <br class="d-none d-lg-block">
                                    フォームからお気軽にどうぞ
                                </h2>
                                ...
                                <div class="contact-schedule">
                                    ...
                                    <div class="schedule-embed" data-booking-url="">
                                        ...
                                        <div class="schedule-fallback">
                                            <p>オンライン予約は準備中です。それまではメールでご連絡ください。Google Meetのリンクをお送りします。</p>
                                            <a href="mailto:Kohandezh@hotmail.com" class="tf-btn-action"><span class="text text-body-3 fw-medium">メールで予約する</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <noscript>
        ...
        <section class="linkedin-noscript" aria-labelledby="linkedin-noscript-title">
            <h2 id="linkedin-noscript-title">LinkedInの推薦とアクティビティ</h2>
            <p>モハンマド・アリ・コハンデジュの公開LinkedInアカウントからの推薦とアクティビティへのリンク。</p>
            <ul>
            ...
            <h3>最近のLinkedInアクティビティ</h3>
            <ul>
                <li><a href="https://www.linkedin.com/feed/update/urn:li:activity:7388299488152424448/" target="_blank" rel="noopener noreferrer">GITEX 2025 — 世界の技術イノベーションを分析する</a> · <time datetime="2025-10-26">Oct 26, 2025</time></li>
                <li><a href="https://www.linkedin.com/feed/update/urn:li:activity:7382455627651919872/" target="_blank" rel="noopener noreferrer">Expand North Star — 世界最大のスタートアップイベント</a> · <time datetime="2025-10-10">Oct 10, 2025</time></li>
            </ul>
        </section>
    </noscript>
